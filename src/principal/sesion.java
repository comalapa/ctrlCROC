...
public class sesion extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        txtusuario.setCaretColor(new java.awt.Color(204, 153, 0));

        jLabel3.setFont(new java.awt.Font("Berlin Sans FB", 1, 24)); // NOI18N
        jLabel3.setText("CONTRASEÑA");

        txtcont.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 18)); // NOI18N
        txtcont.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));
        txtcont.setCaretColor(new java.awt.Color(204, 153, 0));
    ...
    private void btniniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btniniciarActionPerformed
        if(txtusuario.getText().equals("admin") && txtcont.getText().equals("admin")){
            this.dispose();
        }
        else{
